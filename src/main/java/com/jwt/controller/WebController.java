...
public class WebController {
    ...
    public String postList(@RequestParam(defaultValue = "0") int page,
        ...
        Page<BoardDto.Response> posts = boardService.getPublicPosts(category, pageable);
    ...
    public String postDetail(@PathVariable Long postId, Model model, @AuthenticationPrincipal User user, RedirectAttributes redirectAttributes) {
        try {
            BoardDto.Response post = boardService.getBoardById(postId);
            model.addAttribute("post", post);
            model.addAttribute("board", post);
            model.addAttribute("canComment", authorizationService.isActiveUser(user));
    ...
    public String categorySettings(@AuthenticationPrincipal User user, Model model, RedirectAttributes redirectAttributes) {
        try {
    ...
    @PostMapping("/admin/settings/categories/{categoryId}/edit")
    ...
    @PostMapping("/admin/settings/categories/{categoryId}/delete")
